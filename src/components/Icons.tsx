...
const paths = {
  ...
  pencil: <path d="m17 3 4 4L7 21H3v-4L17 3Z" />,
  trash: (
    <>
  ...
  eyeOff: (
    <>
      <path d="M17.9 17.9A9.9 9.9 0 0 1 12 19.5C5 19.5 1 12 1 12a17.6 17.6 0 0 1 5.1-5.9m3.8-1.4A9.4 9.4 0 0 1 12 4.5C19 4.5 23 12 23 12a17.7 17.7 0 0 1-2.2 3.2" />
